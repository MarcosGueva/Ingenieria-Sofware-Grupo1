...
from controllers.ahorro_controller import router as ahorro_router
from controllers.credito_controller import router as credito_router
from controllers.reporte_controller import router as reporte_router
from controllers.auditoria_controller import router as auditoria_router
from controllers.socio_controller import router as socio_router
from controllers.ingreso_egreso_controller import router as ingreso_egreso_router
from controllers.reporte_ingreso_egreso_controller import router as reporte_ingreso_egreso_router
